...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATCH)/configs/media/media_codecs_performance_8953_v1.xml:$(TARGET_COPY_OUT_VENDOR)etc/media_codecs_performance_8953_v1.xml
	$(LOCAL_PATCH)/configs/media/media_codecs_vendor.xml:$(TARGET_COPY_OUT_VENDOR)etc/media_codecs_vendor.xml
	$(LOCAL_PATCH)/configs/media/media_codecs_vendor_audio.xml:$(TARGET_COPY_OUT_PRODUCT)etc/media_codecs_vendor_audio.xml 
